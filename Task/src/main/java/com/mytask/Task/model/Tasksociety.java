...
public class Tasksociety {
	...
	public Tasksociety(String Label , String Address, Number Phone, String Responsible_name, String Responsible_email,String Nb_Licence, Date Expiration_date )
	{
		this.Label=Label;
